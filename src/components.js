...
import styled, { keyframes, injectGlobal } from "preact-emotion";
...
export const LetterButton = styled("button")`
  ...
  background: ${({ active, color }) =>
    active ? P.darken(0.2, color) : "white"};
`;
...
export const SourceLink = ({color}) => (
  <LinkWrapper>
    <Link href="https://glitch.com/edit/#!/handsomely-twister" color={color}>SOURCE</Link>
  </LinkWrapper>
);
